export default function Lading() {
  return (
    ...
    <div className="bg-[url('/Image/hero.jpg')] w-screen h-screen bg-no-repeat bg-cover ">
        ...
        <p className=" text-[45px] italic backdrop-blur-md absolute text-white  centered">Luxury bus travel from just €2</p>
    </div>
      ...
      <div className="flex flex-row flex-wrap justify-center p-4 gap-8">
        ...
        <div className="flex flex-col w-[400px] border-2 gap-4">
          ...
          <p className="p-3">
            ...
            Municipality. The total population is 75,994 (2011 census),[2] in a total area of 806 km2 .It stands on a
            plateau some 850 m (2,789 ft) above sea level, surrounded by the Morava Mountains. The area of the Old
            Bazaar, including Mirahori Mosque, is considered as the urban core of the city. Founded by the local Ottoman
            Albanian nobleman Ilias Bey Mirahori,
          </p>
          <button className="bg-[#1da1f2] text-white hover:bg-sky-700 w-20 h-10 rounded-lg ml-4 mb-4">
            {' '}
        ...
        <div className="flex flex-col w-[400px] border-2 gap-4">
          ...
          <p className="p-3">
            ...
            It is located in a valley between the Gjerë mountains and the Drino, at 300 metres above sea level. Its old
            town is a UNESCO World Heritage Site, described as a rare example of a well-preserved Ottoman town, built by
            farmers of large estate. The city is overlooked by Gjirokastër Fortress, where the Gjirokastër National
            Folklore Festival is held every five years. 
          </p>
          <button className="bg-[#1da1f2] text-white hover:bg-sky-700 w-20 h-10 rounded-lg  ml-4 mb-4">
            {' '}
        ...
        <div className="flex flex-col w-[400px] border-2 gap-4">
          ...
          <p className="p-3">
            ...
            city in the Republic of Albania and seat of Sarandë Municipality. Geographically, the city is located on an
            open sea gulf of the Ionian Sea within the Mediterranean Sea. Stretching along the Albanian Ionian Sea
            Coast, Sarandë has a Mediterranean climate with over 300 sunny days a year.In ancient times, the city was
            known as Onchesmus or Onchesmos and was a port-town of Chaonia in ancient Epirus. It owes its modern name to
        ...
        <div className="flex flex-col w-[400px] border-2 gap-4">
          ...
          <p className="p-3">
            ...
            of the Republic of Albania and seat of Vlorë County and Vlorë Municipality. Located in southwestern Albania,
            Vlorë sprawls on the Bay of Vlorë and is surrounded by the foothills of the Ceraunian Mountains along the
            Albanian Adriatic and Ionian Sea Coasts. It experiences a Mediterranean climate, which is affected by the
            Ceraunian Mountains and the proximity to the Mediterranean Sea.
          </p>
          <button className="bg-[#1da1f2] text-white hover:bg-sky-700 w-20 h-10 rounded-lg  ml-4 mb-4">
            {' '}
        ...
        <div className="flex flex-col w-[400px] border-2 gap-4">
          ...
          <p className="p-3">
            ...
            and the seat of Shkodër County and Shkodër Municipality. Shkodra has been continuously inhabited since the
            Early Bronze Age and it has roughly 2,200 years of recorded history. The city sprawls across the Plain of
            Mbishkodra between the southern part of Lake Shkodër and the foothills of the Albanian Alps on the banks of
            Buna, Drin and Kir.Due to its proximity to the Adriatic Sea, Shkodër is affected by a seasonal Mediterranean.
          </p>
          <button className="bg-[#1da1f2] text-white hover:bg-sky-700 w-20 h-10 rounded-lg  ml-4 mb-4">
            {' '}
